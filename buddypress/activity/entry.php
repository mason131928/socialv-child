 ...
 */
 ...
 //看當前網址或者referer有沒有設定filter參數
// $current_url = esc_url(add_query_arg($_GET, home_url($wp->request)));
// //echo '當前網址：' . $current_url.'<br />';
// $filter_id='';
...
//     if(!empty($filter_id)){
//      if( (int)summ_gamipress_log_extra_data_activity_id_with_achievement_id(bp_get_activity_id())!== (int)$filter_id){
//         return;
//     }
//     }
//filter結束
