 ...
 * @author Lucas
 */
add_shortcode( 'guppy_charity_sustainability_project_phone_auth', 'guppy_charity_sustainability_project_phone_auth_shortcode' );

/**
 * Function for custom_phone_verification_shortcode action.
 */
function guppy_charity_sustainability_project_phone_auth_shortcode() {
...
// 		}
	...
	<p>1.請輸入手機號碼：</p>
		...
		<p><label for="verification_code">3.請輸入驗證碼：</label></p>
			<input style="" type="text" name="verification_code" required>
